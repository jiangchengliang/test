...
public class YdepositJframe extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					YdepositJframe frame = new YdepositJframe(id);
	 ...
	 * Create the frame.
	 */
	public YdepositJframe(String id) {
		setTitle("\u5B58\u6B3E\u754C\u9762");
		this.id=id;
		...
		JLabel lblNewLabel = new JLabel("\u8BF7\u8F93\u5165\u8981\u5B58\u7684\u91D1\u989D");
		...
		btnNewButton.setBounds(304, 82, 109, 46);
		...
		lblNewLabel_2.setBounds(0, 0, 446, 273);
